...
let yymbox = {
    ...
    msgbox: function (text, timeout = 3000,h="250px", color = "#f0709c") {
        ...
        yymbox.my_drop ? yymbox.my_drop(document.querySelector("#msgbox"), "fixed") : 0;
...
yymbox["data"] = [
    ...
    {
        name: "自动点击",
        children: [{ name: "编辑页面" }, { name: "复制选中文本" }, { name: "清除脚本" }, { name: "" }, { name: "" },]
    },
    {
        name: "页面文本",
...
yymbox["load"] = function () {
    function create_btn(dom, obj) {
        ...
        obj.func = obj.func || function (e, obj) { yymbox.msgbox("未定义", 3000) };
